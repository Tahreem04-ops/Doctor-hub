...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Doctor Hub — Allopathic, Homeopathic & Herbal Care" },
      { name: "description", content: "Search and book trusted doctors across allopathic, homeopathic, and herbal care. Manage appointments, prescriptions, and medical history in one place." },
      { property: "og:title", content: "Doctor Hub" },
      { property: "og:description", content: "Unified healthcare consultation & patient history." },
